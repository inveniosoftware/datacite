...
validator = validator_factory(
    importlib_resources.files("datacite") / "schemas/datacite-v4.6.json"
)


def dump_etree(data):
    """Convert JSON dictionary to DataCite v4.6 XML as ElementTree."""
    return dump_etree_helper(data, rules, ns, root_attribs)


def tostring(data, **kwargs):
    """Convert JSON dictionary to DataCite v4.6 XML as string."""
    return etree_to_string(dump_etree(data), **kwargs)


def validate(data):
    """Validate DataCite v4.6 JSON dictionary."""
